...
def test_update_abiotic_model(dummy_climate_data, cfg_string):
    ...
    friction_velocity_exp = DataArray([0.154091, 0.154091, 0.154091])

    wind_speed_exp = np.full((15, 3), np.nan)
    wind_speed_exp[[0, 1, 2, 3, 11, 12], :] = [
        [0.694646, 0.694646, 0.694646],
        [0.694646, 0.694646, 0.694646],
        [0.663454, 0.663454, 0.663454],
        [0.606108, 0.606108, 0.606108],
        [0.571985, 0.571985, 0.571985],
        [0.566552, 0.566552, 0.566552],
    ]
    ...
    exp_gv = DataArray(
        np.concatenate(
            [
                ...
                [
                    [0.524844, 0.524844, 0.524844],
                    [0.512624, 0.512624, 0.512624],
                    [0.489547, 0.489547, 0.489547],
                ],
