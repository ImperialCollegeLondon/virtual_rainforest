...
def test_update_abiotic_model(dummy_climate_data, cfg_string):
    ...
    friction_velocity_exp = DataArray([0.162293, 0.163096, 0.163727])

    wind_speed_exp = np.full((15, 3), np.nan)
    wind_speed_exp[[0, 1, 2, 3, 11, 12], :] = [
        [0.628988, 0.632101, 0.634546],
        [0.623922, 0.62701, 0.629435],
        [0.597305, 0.600261, 0.602583],
        [0.546485, 0.54919, 0.551315],
        [0.51759, 0.520152, 0.522164],
        [0.512979, 0.515518, 0.517513],
    ]
    ...
    exp_gv = DataArray(
        np.concatenate(
            [
                ...
                [
                    [0.49832, 0.499511, 0.500444],
                    [0.48725, 0.488415, 0.489328],
                    [0.465613, 0.466728, 0.467601],
                ],
